...
final class AuditLogEventPresentation
{
    ...
    public static function labels(): array
    {
        return [
            ...
            'pos_caja_bdv_conciliation_manual' => 'Caja: Pago M'.chr(0xC3).chr(0xB3).'vil conciliado manual (OTP)',
            'bdv_pagomovil_conciliation_ok' => 'Conciliaci'.chr(0xC3).chr(0xB3).'n PM BDV: exitosa',
            'bdv_pagomovil_conciliation_failed' => 'Conciliaci'.chr(0xC3).chr(0xB3).'n PM BDV: rechazada o error',
            ...
            'branch_daily_operation_closed' => 'Sucursal: cierre de gesti'.chr(0xC3).chr(0xB3).'n del d'.chr(0xC3).chr(0xAD).'a',
    ...
    public static function badgeColor(string $event): string
    {
        return match (strtolower(trim($event))) {
            ...
            'pos_caja_bdv_conciliation_manual' => 'warning',
            'bdv_pagomovil_conciliation_ok' => 'success',
            'bdv_pagomovil_conciliation_failed' => 'danger',
            'bdv_pagomovil_conciliation_manual' => 'warning',
            'pos_caja_bdv_modal_abandoned' => 'warning',
            'pos_caja_close_pdf_downloaded' => 'info',
            'pos_caja_fiscal_receipt_viewed' => 'gray',
            'cashier_shift_access_granted' => 'success',
            'branch_daily_operation_opened' => 'success',
            'branch_daily_operation_closed' => 'warning',
