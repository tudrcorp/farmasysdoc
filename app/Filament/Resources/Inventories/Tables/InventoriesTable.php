        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('cost_price')
                    ...
                    ->sortable()
                    ->toggleable(),
                TextColumn::make('vat_cost_amount')
                    ->label('Valor del IVA (costo)')
                    ->money()
                    ->alignEnd()
                    ->sortable()
                    ->toggleable(),
                TextColumn::make('cost_plus_vat')
                    ->label('Costo + IVA')
                    ->money()
                    ->alignEnd()
                    ->sortable()
                    ->toggleable(),
                TextColumn::make('final_price_without_vat')
                    ->label('Precio final sin IVA')
                    ->money()
                    ->alignEnd()
                    ->sortable()
                    ->toggleable(),
                TextColumn::make('vat_final_price_amount')
                    ->label('Valor IVA precio final')
                    ->money()
                    ->alignEnd()
                    ->sortable()
                    ->toggleable(),
                TextColumn::make('final_price_with_vat')
