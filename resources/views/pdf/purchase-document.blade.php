...
<body>
    ...
    <table class="lines">
        <thead>
            <tr>
                ...
                <th class="num" style="width:10%">Costo unit.</th>
                <th class="num" style="width:8%">Cant.</th>
                <th class="num" style="width:8%">Desc. %</th>
                <th class="num" style="width:8%">IVA %</th>
                <th class="num" style="width:10%">Subtotal</th>
                <th class="num" style="width:8%">Impuesto</th>
                <th class="num" style="width:12%">Total línea</th>
            </tr>
        </thead>
        <tbody>
    ...
    <div class="summary">
        <table>
            <tr>
                <td>Subtotal documento</td>
                <td>USD {{ number_format((float) $purchase->subtotal, 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Descuentos</td>
                <td>USD {{ number_format((float) $purchase->discount_total, 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Impuestos</td>
                <td>USD {{ number_format((float) $purchase->tax_total, 2, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Total</td>
                <td>USD {{ number_format((float) $purchase->total, 2, ',', '.') }}</td>
            </tr>
        </table>
    </div>
