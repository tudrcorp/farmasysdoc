...
return new class extends Migration
{
    ...
    public function up(): void
    {
        foreach (['GERENCIA', 'GERENTE'] as $roleName) {
            ...
            if (in_array('physical_cash_box_close_reports', $items, true)) {
                continue;
            }

            $items[] = 'physical_cash_box_close_reports';
    ...
    public function down(): void
    {
        foreach (['GERENCIA', 'GERENTE'] as $roleName) {
            ...
            $items = array_values(array_filter(
                ...
                static fn (mixed $key): bool => $key !== 'physical_cash_box_close_reports',
            ));
            $rol->allowed_menu_items = $items;
            $rol->save();
        }
