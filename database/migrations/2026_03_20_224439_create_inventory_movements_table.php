...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('inventory_movements', function (Blueprint $table) {
            ...
            $table->unsignedInteger('product_id')->comment('Producto afectado');
            $table->unsignedInteger('inventory_id')->comment('Registro de inventario relacionado (sucursal + producto)');
