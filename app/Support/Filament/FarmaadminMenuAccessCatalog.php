...
class FarmaadminMenuAccessCatalog
{
    ...
    public static function items(): array
    {
        return [
            ...
            'cachea_conciliations' => ['label' => 'Conciliaciones Cachea', 'route_name_fragment' => 'resources.conciliation-cacheas.', 'group' => 'Operaciones'],
            ...
            'cashier_shift_access' => ['label' => 'Acceso cajeros (turno)', 'route_name_fragment' => 'pages.acceso-cajeros-turno', 'group' => 'Configuración'],
            'bdv_playground' => ['label' => 'BDV — APIs (pruebas)', 'route_name_fragment' => 'pages.bdv-conciliation-playground', 'group' => 'Configuración'],
            'hr_employees' => ['label' => 'Empleados', 'route_name_fragment' => 'resources.hr.employees.', 'group' => 'Recursos Humanos'],
            'hr_assignments' => ['label' => 'Asignaciones', 'route_name_fragment' => 'resources.hr.assignments.hr-assignments.', 'group' => 'Recursos Humanos'],
            'hr_deductions' => ['label' => 'Deducciones', 'route_name_fragment' => 'resources.hr.deductions.hr-deductions.', 'group' => 'Recursos Humanos'],
            'hr_loans' => ['label' => 'Préstamos', 'route_name_fragment' => 'resources.hr.loans.hr-loans.', 'group' => 'Recursos Humanos'],
            'hr_payroll' => ['label' => 'Nómina', 'route_name_fragment' => 'resources.hr.payroll-periods.', 'group' => 'Recursos Humanos'],
