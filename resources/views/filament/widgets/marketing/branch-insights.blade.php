...
<x-filament-widgets::widget class="fi-wi-widget fi-marketing-branch-insights">
    ...
    >
        <div class="fi-marketing-branch-insights__toolbar">
            <div class="fi-marketing-branch-insights__toolbar-inner">
                <label class="fi-marketing-branch-insights__field">
                    <span class="fi-marketing-branch-insights__field-label">
        ...
        >
            <div class="fi-marketing-branch-insights__panel fi-marketing-branch-insights__panel--table">
                <div class="fi-marketing-branch-insights__panel-head">
                    <h3 class="fi-marketing-branch-insights__panel-title">Ranking de sucursales</h3>
            ...
            >
                @if ($detail)
                    <div class="fi-marketing-branch-insights__panel fi-marketing-branch-insights__panel--hero">
                        <p class="fi-marketing-branch-insights__eyebrow">Sucursal seleccionada</p>
                        <p class="fi-marketing-branch-insights__branch-name">
                            {{ $detail['name'] }}
                        </p>
                        <div class="fi-marketing-branch-insights__highlight-box">
                            <p class="fi-marketing-branch-insights__highlight-label">
                                Producto más vendido (unidades)
                            </p>
                            <p class="fi-marketing-branch-insights__highlight-value">
                                {{ $detail['top_product'] }}
                            </p>
                        </div>
                    </div>

                    <div class="fi-marketing-branch-insights__panel fi-marketing-branch-insights__panel--clients">
                        <h4 class="fi-marketing-branch-insights__panel-title">Top 10 clientes por compras</h4>
                        <p class="fi-marketing-branch-insights__panel-sub">
                                ...
                                @foreach ($detail['top_clients'] as $i => $c)
                                    <li class="fi-marketing-branch-insights__client-item">
                                        <span class="fi-marketing-branch-insights__client-left">
                                            <span class="fi-marketing-branch-insights__client-rank">{{ $i + 1 }}</span>
                                            <span class="fi-marketing-branch-insights__client-name">{{ $c->client_name }}</span>
                                        </span>
                                        <span class="fi-marketing-branch-insights__client-count">
