...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="ep-html" data-theme="light">
    <head>
        ...
        <title>Enlace no válido · Portal · Farmadoc</title>
            ...
            <div class="ep-app">
                <div class="ep-status">
                    <div>
                        ...
                        <h1 class="ep-lead">Este enlace ya no sirve</h1>
                        <p class="ep-text">No pasa nada: puedes entrar siempre con tu cédula o tu teléfono.</p>
                        <div class="ep-actions">
                            <a href="{{ route('employee-portal.login') }}" class="ep-btn ep-btn--primary">Entrar al portal</a>
                        </div>
                    </div>
                </div>
            </div>
