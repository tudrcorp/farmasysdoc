...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('conciliation_cacheas', function (Blueprint $table): void {
            $table->id()->comment('Identificador interno de conciliación Cashea');
            ...
            $table->decimal('cachea_paid_amount', 14, 2)->comment('Monto pagado por el cliente vía Cashea (USD)');
            $table->decimal('remainder', 14, 2)->comment('Resto = venta total − pago Cashea (USD pendiente Cashea)');
